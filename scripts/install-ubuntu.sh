...
# Usage: curl -fsSL https://raw.githubusercontent.com/Infomanta/im3270-releases/main/scripts/install-ubuntu.sh | bash
...
RELEASE_URL="https://github.com/Infomanta/im3270-releases/releases/latest/download/IM3270-0.46.11.AppImage"
